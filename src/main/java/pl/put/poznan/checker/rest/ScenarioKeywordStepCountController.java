...
// import ch.qos.logback.core.net.ObjectWriter;import pl.put.poznan.checker.logic.ScenarioDataInput;
...
@RestController
@RequestMapping(value = { "/keywordStepCount/{id}", "/keywordStepCount" })
...
public class ScenarioKeywordStepCountController {
    ...
    public int get(@PathVariable(value = "id", required = false) String id,
        ...
        return scenarioQualityChecker.countKeywordSteps();
    }
